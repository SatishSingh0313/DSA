...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] rearranged1 = solution.rearrangeArray(nums1);
        System.out.println("Example 1: " + Arrays.toString(rearranged1)); // Output: [3, -2, 1, -5, 2, -4]

        // Example 2
        int[] nums2 = {-1, 1};
        int[] rearranged2 = solution.rearrangeArray(nums2);
        System.out.println("Example 2: " + Arrays.toString(rearranged2)); // Output: [1, -1]
    }
}