...
A sub array of an array is obtained by removing some(zero or more) elements
 from the front and back of the array.
...
Explanation: Sub arrays have bitwise xor equal to ‘2’ are: [1, 2, 3, 2], [2], [2]. */
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int subarraysCount = subarraysWithSumK(a, b);
        System.out.println("Number of sub Arrays with bitwise XOR equal to " + b + ": " + subarraysCount);
    }
}
