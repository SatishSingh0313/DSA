...
If there is no sub array whose sum is ‘K’ then you should return 0.
...
There are two sub arrays with sum = 4, [1, 2, 1] and [2, 1, 0, 1]. Hence the length of the longest subarray with sum = 4 is 4. */
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] nums = {1, 2, 1, 0, 1};
        int k = 4;
        System.out.println("Sub array Output is: " + Solution.getLongestSubarray(nums, k)); // Output: 4
    }
}
